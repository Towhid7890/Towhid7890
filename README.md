...
<h3 align="left">Languages and Tools:</h3>
  <p align="left">
        ...
        <a href="https://tailwindcss.com/" target="_blank" rel="noreferrer">
          {" "}
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRYqYIEBUQfBPkFTiqZ2FjSayBcM3l4ryV9Vw&usqp=CAU"
            alt="tailwind"
            width="40"
            height="40"
          />{" "}
        ...
        <a href="https://daisyui.com/" target="_blank" rel="noreferrer">
          {" "}
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT3sSbxKAg_Ydfw8autBeVHJ4UpergrIbnoGQ&usqp=CAU"
            alt="daisy"
            width="40"
            height="40"
          />{" "}
